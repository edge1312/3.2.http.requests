...
if __name__ == '__main__':
    ...
    print(f"По-английски: {translate_it(text, 'en')}")
    print(f"По-немецки: {translate_it(text, 'de')}")
    print(f"По-испански: {translate_it(text, 'es')}")
    print(f"По-французски: {translate_it(text, 'fr')}")